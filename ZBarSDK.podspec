#
#  Be sure to run `pod spec lint ZBar.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "RodYang" => "277748999@qq.com" }
  # Or just: s.author    = "RodYang"
  # s.authors            = { "RodYang" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/RodYang"
  ...
  s.source       = { :git => "https://github.com/RodYang/ZBar.git", :tag => "#{s.version}" }
